...
| 3b | Live private AWS foundation, workload identity, infrastructure and runtime verification | Connectivity/identity tests demonstrate required isolation; fresh worker-bound evidence; independent shutdown | Pending selected AWS topology and live verification |
